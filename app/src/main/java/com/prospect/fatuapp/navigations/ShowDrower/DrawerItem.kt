...
@Composable
fun DrawerItem(item: DrowerNavItemScreens, selected: Boolean, onItemClick: (DrowerNavItemScreens) -> Unit) {
...
private fun PreviewDrawerItem() {
    DrawerItem(item = DrowerNavItemScreens.AddProductToPos, selected = false, onItemClick = {})
}